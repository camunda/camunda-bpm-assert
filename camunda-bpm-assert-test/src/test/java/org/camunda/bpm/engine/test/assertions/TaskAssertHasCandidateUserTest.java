...
public class TaskAssertHasCandidateUserTest extends ProcessAssertTestCase {
  ...
  public void testHasCandidateUserPreDefined_Success() {
    ...
    // Then
    assertThat(processInstance).task().hasCandidateUser("candidateUser");
  }
  ...
  public void testHasCandidateUser_Predefined_Removed_Failure() {
    ...
    // When
    taskService().deleteCandidateUser(taskQuery().singleResult().getId(), "candidateUser");
    // Then
    expect(new Failure() {
      @Override
      public void when() {
  ...
  public void testHasCandidateUser_NonExistingTask_Failure() {
    ...
    expect(new Failure() {
      @Override
      public void when() {
        assertThat(task).hasCandidateUser("candidateUser");
      }
    });
  }
