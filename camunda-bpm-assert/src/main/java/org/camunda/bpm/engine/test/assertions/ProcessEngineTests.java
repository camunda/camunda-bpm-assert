...
public class ProcessEngineTests extends ProcessEngineAssertions {
	...
	public static CaseExecution caseExecution(String activityId, CaseInstance caseInstance) {
		CaseExecution caseExecution = caseService().createCaseExecutionQuery()
				.caseInstanceId(caseInstance.getCaseInstanceId()).activityId(activityId).singleResult();
		assertThat(caseExecution).overridingErrorMessage("CaseExecution for activity '" + activityId + "' not found!")
				.isNotNull();
	...
	public static HistoricCaseActivityInstance caseActivity(String activityId, CaseInstance caseInstance) {
		HistoricCaseActivityInstance activityInstance = historicCaseActivityInstanceQuery()
				.caseInstanceId(caseInstance.getCaseInstanceId()).caseActivityId(activityId).singleResult();
		Assertions.assertThat(activityInstance)
				.overridingErrorMessage("ActivityInstance for activity '" + activityId + "' not found!").isNotNull();
