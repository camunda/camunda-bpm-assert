...
public interface FluentDeployment extends FluentDelegate<DeploymentBuilder> {
     ...
     * @param resources vararg list of bpmn file-paths in classpath
     * @return this instance for fluent use
     */
    FluentDeployment addClasspathResource(final String... resources);

    /**
     * Performs deployment and returns the new deploymentId.
     * Delegates to {@link DeploymentBuilder#deploy()}.
     ...
     * @param name name for deployment to identify
     * @return this instance for fluent use
     */
     ...
     * @param zipInputStream zip archive stream with process to deploy
     * @return this instance for fluent use
     */
     ...
     * @param resourceName name for the given bpmn resource to create
     * @param text bpmn content to deploy
     * @return this instance for fluent use
     */
     ...
     * @param resourceName name for the given bpmn resource to create
     * @param inputStream stream containing bpmn content to deploy
     * @return this instance for fluent use
     */
