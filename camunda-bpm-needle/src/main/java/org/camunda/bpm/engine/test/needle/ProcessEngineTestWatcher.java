...
public class ProcessEngineTestWatcher extends TestWatcher implements ProcessEngineTestRule {
    ...
    /**
     * Holds the deploymentId after execution of @Deployment. can be used to query the {@link RepositoryService}.
     */
     ...
     * @param configurationResource name of the configuration file (e.g. activiti.cfg.xml)
     ...
     * @param processEngine the ProcessEngine instance to use
     */
